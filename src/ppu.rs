...
mod tests {
    ...
    test_roms!("ppu", {
        ...
        (spr_hit_timing, 0, 0, "flag set too soon for upper-right corner #5"),
        (spr_hit_timing_order, 0, 0, "hit time shouldn't be based on pixels at X=255 #7"),
        ...
        (spr_overflow_obscure, 0, 0, "fails #2"),
