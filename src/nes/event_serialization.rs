...
use pix_engine::event::{Axis, Button, Event, Key, Mouse};
use std::io::{Read, Write};

impl Savable for Event {
    fn save<F: Write>(&self, fh: &mut F) -> NesResult<()> {
        match *self {
            Event::Unknown => 0u8.save(fh)?,
            Event::Quit => 1u8.save(fh)?,
            Event::AppTerminating => 2u8.save(fh)?,
            Event::ControllerDown {
                controller_id,
                button,
            } => {
                3u8.save(fh)?;
                controller_id.save(fh)?;
                button.save(fh)?;
            }
            Event::ControllerUp {
                controller_id,
    ...
    fn load<F: Read>(&mut self, fh: &mut F) -> NesResult<()> {
        ...
        //         btn.load(fh)?;
        //         pressed.load(fh)?;
        //         Event::ControllerDown(id, btn, pressed)
        //     }
        //     4 => {
        //         let mut id: u32 = 0;
        ...
        //         axis.load(fh)?;
        //         value.load(fh)?;
        //         Event::ControllerAxisMotion(id, axis, value)
        //     }
        //     5 => {
        ...
        //         pressed.load(fh)?;
        //         repeat.load(fh)?;
        //         Event::KeyDown(key, pressed, repeat)
        //     }
        //     6 => {
        ...
        //         y.load(fh)?;
        //         pressed.load(fh)?;
        //         Event::MouseDown(mouse, x, y, pressed)
        //     }
        //     7 => {
        //         let mut delta = 0;
        //         delta.load(fh)?;
        ...
        //         window_id.load(fh)?;
        //         focused.load(fh)?;
        //         Event::Focus(window_id, focused)
        //     }
        //     12 => {
        //         let mut is_background = false;
        //         is_background.load(fh)?;
        //         Event::Background(is_background)
        //     }
        //     _ => return nes_err!("invalid Event value"),
        // };
        // Ok(())
    }
}
