...
use crate::{
    ...
    mem::{DynMemory, Mem, StaticMemory},
    ppu::{Mirroring, Ppu},
};
...
pub struct Bus {
    ...
    pub ciram: StaticMemory<u8, 0x0800>, // $2007 PPUDATA
    pub palette: StaticMemory<u8, 32>,
...
impl Bus {
    ...
    pub fn new() -> Self {
        Self {
            mapper: Mapper::none(),
            ciram: StaticMemory::new(),
            palette: StaticMemory::new(),
