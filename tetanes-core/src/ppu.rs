...
pub struct Ppu {
    ...
    pub oamdata: StaticMemory<u8, 256>,
    /// Secondary OAM data on a given scanline.
    pub secondary_oamdata: StaticMemory<u8, 32>,
    ...
    pub spr_present: StaticMemory<bool, 256>,
...
impl Ppu {
    ...
    pub fn new(region: NesRegion) -> Self {
        let mut ppu = Self {
            ...
            oamdata: StaticMemory::new(),
            secondary_oamdata: StaticMemory::new(),
            sprites: [Sprite::new(); 8],
            spr_present: StaticMemory::new(),
