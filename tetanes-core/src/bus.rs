...
use crate::{
    ...
    mem::{Memory, RamState, Read, Write},
    ppu::{Ppu, Registers},
};
        ...
        let val = match addr {
            ...
            0x4020..=0xFFFF => {
                let val = match self.ppu.bus.mapper.map_read(addr) {
                    ...
                    | MappedRead::Chr(_)
                    | MappedRead::CIRam(_)
                    | MappedRead::ExRam(_) => self.open_bus,
                };
